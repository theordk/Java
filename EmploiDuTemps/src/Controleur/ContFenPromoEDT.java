 ...
 * @author 931702061
 */
public class ContFenPromoEDT {
    private final FenPromoEDT f_promo_EDT;
    private int id;
    //Constructeur du Controle de ma fenetre d'acceuil
    public ContFenPromoEDT(FenPromoEDT f, int id){
          this.f_promo_EDT = f;
          this.id = id;
    }
