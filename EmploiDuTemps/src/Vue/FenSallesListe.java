...
public class FenSallesListe extends JFrame implements ActionListener {
    ...
    JButton bSelect;
    private final ContFenSallesListe cont_fen_sallesListe;

    public FenSallesListe(int id) {

        super("FenSallesListe");
       proprieteFenetre();
        cont_fen_sallesListe = new ContFenSallesListe(this,id);
        
        bAcceuil = new JButton("Acceuil");
        bAcceuil.setSize(new Dimension(100,100));
        ...
        panel.add(ListSalles(this,id), BorderLayout.CENTER);
    ...
    private JMenuBar createMenuBar(int id) {
       ...
       private JToolBar createToolBar(FenSallesListe f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_sallesListe.bAcceuilclicked(e); 
        ...
        f.bEnseignants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_sallesListe.bEnsclicked(e); 
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_sallesListe.bPromoclicked(e); 
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_sallesListe.bGroupeclicked(e); 
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_sallesListe.bEtudiantclicked(e); 
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_sallesListe.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_sallesListe.bSallesclicked(e);
    ...
    private JPanel ListSalles(FenSallesListe f, int id) {
        
        JPanel panel = new JPanel();
        panel.setLayout(new GridLayout(1,2)); //--> Grille (l,c)
        //setSize(800,800);
        
        DAO<Salle> sallesDAO = new SalleDAO(Connexion.getInstance());
        ArrayList<Salle> listeSalles = new ArrayList<>();
        ArrayList<String> items = new ArrayList<String>(); 
        String promo = "";
        
        listeSalles = sallesDAO.findAll();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i=0; i<indice.length; i++){
                    ...
                    if (indice[i] == 0) { //2021 --> 5
                        ...
                        closeFenSallesListe();
                        FenSallesEDT fedt_salles = new FenSallesEDT(0,id);
                    ...
                    if (indice[i] == 1) { //2021 --> 5
                        ...
                        //System.out.println("okk");
                        closeFenSallesListe();
                        FenSallesEDT fedt_salles = new FenSallesEDT(1,id);
                    ...
                    if (indice[i] == 2) { //2021 --> 5
                        ...
                        //System.out.println("okk");
                        closeFenSallesListe();
                        FenSallesEDT fedt_salles = new FenSallesEDT(2,id);
                    ...
                    if (indice[i] == 3) { //2021 --> 5
                        ...
                        //System.out.println("okk");
                        closeFenSallesListe();
                        FenSallesEDT fedt_salles = new FenSallesEDT(3,id);
                    ...
                    if (indice[i] == 4) { //2021 --> 5
                        ...
                        //System.out.println("okk");
                        closeFenSallesListe();
                        FenSallesEDT fedt_salles = new FenSallesEDT(4,id);
                    ...
                    if (indice[i] == 5) { //2021 --> 5
                        ...
                        //System.out.println("okk");
                        closeFenSallesListe();
                        FenSallesEDT fedt_salles = new FenSallesEDT(5,id);
                    ...
                    if (indice[i] == 6) { //2021 --> 5
                        ...
                        //System.out.println("okk");
                        closeFenSallesListe();
                        FenSallesEDT fedt_salles = new FenSallesEDT(6,id);
