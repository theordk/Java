...
public class FenCoursListe extends JFrame implements ActionListener {
    ...
    JButton bSelect;
    private final ContFenCoursListe cont_fen_coursListe;
            
    public FenCoursListe(int id) {

        super("FenCoursListe");
        proprieteFenetre();
        cont_fen_coursListe = new ContFenCoursListe(this,id);
        ...
        panel.add(ListCours(this,id), BorderLayout.CENTER);
    ...
    private JToolBar createToolBar(FenCoursListe f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_coursListe.bAcceuilclicked(e);
        ...
        f.bEnseignants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_coursListe.bEnsclicked(e);
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_coursListe.bPromoclicked(e);
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_coursListe.bGroupeclicked(e);
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_coursListe.bEtudiantclicked(e);
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_coursListe.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_coursListe.bSallesclicked(e);
    ...
    private JPanel ListCours(FenCoursListe f, int id) {
        ...
        f.bSelect.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                //System.out.println("selected item :" + indice);
                
                for (int i=0; i<indice.length; i++){ //Parcours des incices
                    ...
                    if (indice[i] == 0) { //Maths
                        ...
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(0,id);
                    ...
                    if (indice[i] == 1) { //Info
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(1,id);
                    ...
                    if (indice[i] == 2) { //Elec
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(2,id);
                    ...
                    if (indice[i] == 3) { //LV2
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(3,id);
                    ...
                    if (indice[i] == 4) { //Thermo
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(4,id);
                    ...
                    if (indice[i] == 5) { //Anglais
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(5,id);
                    ...
                    if (indice[i] == 6) { //Droit
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(6,id);
                    ...
                    if (indice[i] == 7) { //POO Java
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(7,id);
                    ...
                    if (indice[i] == 8) { //Physique
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(8,id);
                    ...
                    if (indice[i] == 9) { //WebDynamique
                        ...
                        //System.out.println("okk");
                        closeFenCoursListe();
                        FenCoursEDT fedt_cours = new FenCoursEDT(9,id);
