...
public class FenetreEE_EDT extends JFrame implements ActionListener {

    private final JPanel panel;

    private final ContFenetreEE_EDT cont_edt;
    //private final Utilisateur id_ut;

    private final JButton bEDT, bRecapCours;
    private final JButton bAcceuil, bEDTTool, bRecapCoursTool;
    private final JTable table;
    private final JButton sem21, sem22, sem23;
    private final int  sem=22;
    //private final JLabel titre;

    //private final JTextArea txt1;
    //private final JScrollPane scroll_1;
    public FenetreEE_EDT(int id) {

        //id_ut = new Utilisateur().getId();
        cont_edt = new ContFenetreEE_EDT(this, id);
        ...
        sem21 = new JButton("Semaine 21");
        sem22 = new JButton("Semaine 22");
        sem23 = new JButton("Semaine 23");
        
        //titre = new JLabel("Mon emploi du temps");
        ...
        panel.add(createEDT(this, id, sem), BorderLayout.CENTER);
    ...
    private JToolBar createToolBar(FenetreEE_EDT f) {
    ...
    //Affichage de l'EDT SELON Identifiant + Semaine
    private JPanel createEDT(FenetreEE_EDT f, int id, int sem) {
        ...
        JLabel txt = new JLabel("Mon Emploi du Temps : "+"Semaine"+sem);
...
//            sem21.addActionListener(new ActionListener() {
//            public void actionPerformed(ActionEvent e) {
//                if (week == ) {
//                
//                }
...
//                            System.out.println("*************************************************");
        ...
        panel.add(semaine, BorderLayout.CENTER);
