...
public class FenCoursEDT extends JFrame implements ActionListener {
    ...
    JButton bSelect;
    private final ContFenCoursEDT cont_cours_EDT;

    public FenCoursEDT(int indice, int id) {

        super("FenCoursEDT");
        proprieteFenetre();
        cont_cours_EDT = new ContFenCoursEDT(this,id);
    ...
    private JToolBar createToolBar(FenCoursEDT f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_cours_EDT.bAcceuilclicked(e);
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_cours_EDT.bPromoclicked(e);
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_cours_EDT.bGroupeclicked(e);
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_cours_EDT.bEtudiantclicked(e);
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_cours_EDT.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_cours_EDT.bSallesclicked(e);
    ...
    private JPanel createEDT(FenCoursEDT f,int i) {
        ...
        for (Seance s : seances) {
            ...
            if (s.getId_cours() == id_cours) {  //si l'ID d'un des groupes correspond a l'ID du groupe de cet etudiant

                seancesCours.add(seanceDAO.find(s.getId()));

            }
        }

        for (Seance s : seancesCours) { //toutes les seances
