...
public class FenPromoEDT extends JFrame implements ActionListener{
   ...
   // private Connexion maconnexion;
    ...
    JButton bSelect;
    private final ContFenPromoEDT cont_promo_EDT;

    public FenPromoEDT(int indice, int id) {
        
        super("FenPromoEDT");
        proprieteFenetre();
        cont_promo_EDT = new ContFenPromoEDT(this, id);
    ...
    private JToolBar createToolBar(FenPromoEDT f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_promo_EDT.bAcceuilclicked(e);
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_promo_EDT.bPromoclicked(e);
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_promo_EDT.bGroupeclicked(e);
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_promo_EDT.bEtudiantclicked(e);
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_promo_EDT.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_promo_EDT.bSallesclicked(e);
    ...
    private JPanel createEDT(FenPromoEDT f, int i) {
        ...
        ArrayList<Seance> seancesDePromo = new ArrayList<>();
        ...
        s_g = s_gDAO.findAll();
            ...
            for(Seance s : seances){ //On remplie seanceDePromo

                            //On recupere le Groupe
                                for(Seance_Groupe sg : s_g){
                                        //pour chaque Seance_Groupe on regarde l'id grp
                                        if(sg.getId_s() == s.getId()){ //on compare les id seance
                                            
                                            id_groupe = sg.getId_g(); //on recup le groupe
                                            
                                            if(id_promotion == groupeDAO.find(id_groupe).getId_promo()){
                                                
                                                seancesDePromo.add(s);
                                            }
            ...
            for(Seance s : seancesDePromo){ //on recupere tout de SeanceDePromo
