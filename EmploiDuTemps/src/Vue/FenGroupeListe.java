...
public class FenGroupeListe extends JFrame implements ActionListener {
    ...
    JButton bSelect;
    private final ContFenGroupeListe cont_fen_groupeListe;

    public FenGroupeListe(int id) {

        super("FenGroupeListe");
        proprieteFenetre();
        cont_fen_groupeListe = new ContFenGroupeListe(this, id);
        ...
        panel.add(ListGroupe(this, id), BorderLayout.CENTER);
    ...
    private JMenuBar createMenuBar(int id) {
       ...
       private JToolBar createToolBar(FenGroupeListe f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_groupeListe.bAcceuilclicked(e); 
        ...
        f.bEnseignants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_groupeListe.bEnsclicked(e); 
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_groupeListe.bPromoclicked(e); 
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_groupeListe.bGroupeclicked(e); 
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_groupeListe.bEtudiantclicked(e); 
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_groupeListe.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_groupeListe.bSallesclicked(e);
    ...
    private JPanel ListGroupe(FenGroupeListe f, int id) {
        
        JPanel panel = new JPanel();
        panel.setLayout(new GridLayout(1,2)); //--> Grille (l,c)
        //setSize(800,800);
        
        DAO<Groupe> grDAO = new GroupeDAO(Connexion.getInstance());
        DAO<Promotion> promotionDAO = new PromotionDAO(Connexion.getInstance());
        ArrayList<Groupe> listeGr = new ArrayList<>();
        ArrayList<String> items = new ArrayList<String>(); 
        String groupe = "";
        
        listeGr = grDAO.findAll();
           
        for(Groupe g : listeGr){
            
            //afficher cours
            String promo =  promotionDAO.find(g.getId_promo()).getNom();
            String grp = g.getNom();
            String test = grp + " - Promo " + promo;
            items.add(test);
        ...
        f.bSelect.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i=0; i<indice.length; i++){
                    ...
                    if (indice[i] == 0) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(0,id);
                        
                    }
                    if (indice[i] == 1) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(1,id);
                        
                    }
                    if (indice[i] == 2) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(2,id);
                        
                    }
                    if (indice[i] == 3) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(3,id);
                        
                    }
                    if (indice[i] == 4) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(4,id);
                        
                    }
                    if (indice[i] == 5) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(5,id);
                        
                    }
                    if (indice[i] == 6) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(6,id);
                        
                    }
                    if (indice[i] == 7) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(7,id);
                        
                    }
                    if (indice[i] == 8) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(8,id);
                        
                    }
                    if (indice[i] == 9) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(9,id);
                        
                    }
                    if (indice[i] == 10) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(10,id);
                        
                    }
                    if (indice[i] == 11) { //2021 --> 5
                    
                        //System.out.println("okk");
                        closeFenGroupeListe();
                        FenGroupeEDT fedt_gr = new FenGroupeEDT(11,id);
