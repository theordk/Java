...
public class FenEnsListe extends JFrame implements ActionListener {
    ...
    JButton bSelect;
    private final ContFenEnsListe cont_fen_ensListe;

    public FenEnsListe(int id) {

       super("FenEnsListe");
       proprieteFenetre();
       cont_fen_ensListe = new ContFenEnsListe(this, id);
        ...
        panel.add(ListEns(this,id), BorderLayout.CENTER);
    ...
    private JToolBar createToolBar(FenEnsListe f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_ensListe.bAcceuilclicked(e); 
        ...
        f.bEnseignants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_ensListe.bEnsclicked(e); 
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_ensListe.bPromoclicked(e); 
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_ensListe.bGroupeclicked(e); 
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_ensListe.bEtudiantclicked(e); 
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_ensListe.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_ensListe.bSallesclicked(e);
    ...
    private JPanel ListEns(FenEnsListe f, int id) {
        
        JPanel panel = new JPanel();
        panel.setLayout(new GridLayout(1,2)); //--> Grille (l,c)
        //setSize(800,800);
        
        DAO<Enseignant> ensDAO = new EnseignantDAO(Connexion.getInstance());
        DAO<Utilisateur> utilisateurDAO = new UtilisateurDAO(Connexion.getInstance());
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i=0; i<indice.length; i++){
                    ...
                    if (indice[i] == 0) { //LeCor
                        ...
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(10,id);
                    ...
                    if (indice[i] == 1) { //Info
                        ...
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(0,id);
                    ...
                    if (indice[i] == 2) { //Elec
                        ...
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(2,id);
                    ...
                    if (indice[i] == 3) { //LV2
                        ...
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(24,id);
                        
                    }
                    if (indice[i] == 4) { //Thermo
                    
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(14,id);
                        
                    }
                    if (indice[i] == 5) { //Anglais
                    
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(9,id);
                    ...
                    if (indice[i] == 6) { //Droit
                        ...
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(13,id);
                        
                    }
                    if (indice[i] == 7) { //POO Java
                    
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(6,id);
                        
                    }
                    if (indice[i] == 8) { //Physique
                    
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(8,id);
                        
                    }
                    if (indice[i] == 9) { //WebDynamique
                    
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(15,id);
                        
                    }
                    if (indice[i] == 10) { //WebDynamique
                    
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(16,id);
                        
                    }
                    if (indice[i] == 11) { //WebDynamique
                    
                        //System.out.println("okk");
                        closeFenEnsListe();
                        FenEnsEDT fedt_ens = new FenEnsEDT(17,id);
