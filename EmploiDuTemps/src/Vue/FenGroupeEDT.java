...
public class FenGroupeEDT extends JFrame implements ActionListener{
    ...
    JButton bSelect;
    private final ContFenGroupeEDT cont_groupe_EDT;


    public FenGroupeEDT(int indice, int id) {
        
        super("FenGroupeEDT");
        proprieteFenetre();
        cont_groupe_EDT = new ContFenGroupeEDT(this, id);
    ...
    private JToolBar createToolBar(FenGroupeEDT f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_groupe_EDT.bAcceuilclicked(e);
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_groupe_EDT.bPromoclicked(e);
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_groupe_EDT.bGroupeclicked(e);
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_groupe_EDT.bEtudiantclicked(e);
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_groupe_EDT.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_groupe_EDT.bSallesclicked(e);
    ...
    private JPanel createEDT(FenGroupeEDT f, int i) {
