...
public class FenPromoListe extends JFrame implements ActionListener {
    ...
    JButton bSelect;
    private final ContFenPromoListe cont_fen_promoListe;

    public FenPromoListe(int id) {

        super("FenPromoListe");
        proprieteFenetre();
        cont_fen_promoListe = new ContFenPromoListe(this,id);
        ...
        panel.add(ListPromo(this,id), BorderLayout.CENTER);
    ...
    private JMenuBar createMenuBar(int id) {
       ...
       private JToolBar createToolBar(FenPromoListe f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_promoListe.bAcceuilclicked(e); 
        ...
        f.bEnseignants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_promoListe.bEnsclicked(e); 
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_promoListe.bPromoclicked(e); 
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_promoListe.bGroupeclicked(e); 
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_promoListe.bEtudiantclicked(e); 
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_promoListe.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_fen_promoListe.bSallesclicked(e);
    ...
    private JPanel ListPromo(FenPromoListe f, int id) {
        
        JPanel panel = new JPanel();
        panel.setLayout(new GridLayout(1,2)); //--> Grille (l,c)
        //setSize(800,800);
        
        DAO<Promotion> promoDAO = new PromotionDAO(Connexion.getInstance());
        ArrayList<Promotion> listePromo = new ArrayList<>();
        ArrayList<String> items = new ArrayList<String>(); 
        String promo = "";
        
        listePromo = promoDAO.findAll();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i=0; i<indice.length; i++){
                    ...
                    if (indice[i] == 0) { //2021 --> 5
                        ...
                        closeFenPromoListe();
                        FenPromoEDT fedt_promo = new FenPromoEDT(4,id);
                        
                    }
                    if (indice[i] == 1) { //2022 --> 5
                    
                        //System.out.println("okk");
                        closeFenPromoListe();
                        FenPromoEDT fedt_promo = new FenPromoEDT(3,id);
                        
                    }
                    if (indice[i] == 2) { //2023 --> 6
                    
                        //System.out.println("okk");
                        closeFenPromoListe();
                        FenPromoEDT fedt_promo = new FenPromoEDT(5,id);
