...
public class FenSallesEDT extends JFrame implements ActionListener{
    ...
    JButton bSelect;
    private final ContFenSallesEDT cont_salles_EDT;
    public FenSallesEDT(int indice, int id) {
        
        super("FenSallesEDT");
        proprieteFenetre();
        cont_salles_EDT = new ContFenSallesEDT(this, id);
   ...
   private JMenuBar createMenuBar(int id) {
     ...
     private JToolBar createToolBar(FenSallesEDT f) {
        ...
        f.bAcceuil.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_salles_EDT.bAcceuilclicked(e);
        ...
        f.bPromotions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_salles_EDT.bPromoclicked(e);
        ...
        f.bGroupes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_salles_EDT.bGroupeclicked(e);
        ...
        f.bEtudiants.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_salles_EDT.bEtudiantclicked(e);
        ...
        f.bCours.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_salles_EDT.bCoursclicked(e);
        ...
        f.bSalles.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                cont_salles_EDT.bSallesclicked(e);
    ...
    private JPanel createEDT(FenSallesEDT f, int i) {
        ...
        ArrayList<Seance> seancesDeLaSalle = new ArrayList<>();
        ...
        for(Seance_Salle ss : s_s){
            ...
            if(ss.getId_salle() == id_salle){  //si l'ID d'un des groupes correspond a l'ID du groupe de cet etudiant
                
                
                seancesDeLaSalle.add(seanceDAO.find(ss.getId_s()));
                
            }
        }
        

            for(Seance s : seancesDeLaSalle){ //toutes les seances
                            ...
                            //On recupere Salle et Site
                                ...
                                for(Seance_Salle ss : s_s){
                                        ...
                                        if(ss.getId_s() == s.getId()){
                                          salle = salleDAO.find(id_salle).getNom();

                                          site = siteDAO.find(salleDAO.find(id_salle).getId_site()).getNom();
                                        }
                                }
